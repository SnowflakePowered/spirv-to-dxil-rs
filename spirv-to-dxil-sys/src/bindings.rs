...
pub enum ShaderModel {
    ShaderModel4_0 = 262144,
    ShaderModel4_1 = 262145,
    ShaderModel5_0 = 327680,
    ShaderModel5_1 = 327681,
...
pub struct dxil_spirv_runtime_conf {
    ...
    pub shader_model_max: ShaderModel,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union dxbc_spirv_const_value {
    pub b: bool,
    pub f32_: f32,
    pub f64_: f64,
    pub i8_: i8,
...
#[test]
fn bindgen_test_layout_dxbc_spirv_const_value() {
    const UNINIT: ::std::mem::MaybeUninit<dxbc_spirv_const_value> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<dxbc_spirv_const_value>(),
        8usize,
        concat!("Size of: ", stringify!(dxbc_spirv_const_value))
    );
    assert_eq!(
        ::std::mem::align_of::<dxbc_spirv_const_value>(),
        8usize,
        concat!("Alignment of ", stringify!(dxbc_spirv_const_value))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).b) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(dxbc_spirv_const_value),
            "::",
            stringify!(b)
        )
    );
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dxbc_spirv_specialization {
    pub id: u32,
    pub value: dxbc_spirv_const_value,
    pub defined_on_module: bool,
}
#[test]
fn bindgen_test_layout_dxbc_spirv_specialization() {
    const UNINIT: ::std::mem::MaybeUninit<dxbc_spirv_specialization> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<dxbc_spirv_specialization>(),
        24usize,
        concat!("Size of: ", stringify!(dxbc_spirv_specialization))
    );
    assert_eq!(
        ::std::mem::align_of::<dxbc_spirv_specialization>(),
        8usize,
        concat!("Alignment of ", stringify!(dxbc_spirv_specialization))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).id) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(dxbc_spirv_specialization),
            "::",
            stringify!(id)
        )
    );
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct dxbc_spirv_metadata {
    pub requires_runtime_data: bool,
}
#[test]
fn bindgen_test_layout_dxbc_spirv_metadata() {
    const UNINIT: ::std::mem::MaybeUninit<dxbc_spirv_metadata> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<dxbc_spirv_metadata>(),
        1usize,
        concat!("Size of: ", stringify!(dxbc_spirv_metadata))
    );
    assert_eq!(
        ::std::mem::align_of::<dxbc_spirv_metadata>(),
        1usize,
        concat!("Alignment of ", stringify!(dxbc_spirv_metadata))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).requires_runtime_data) as usize - ptr as usize },
        0usize,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct dxbc_spirv_object {
    pub metadata: dxbc_spirv_metadata,
    pub binary: dxbc_spirv_object__bindgen_ty_1,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct dxbc_spirv_object__bindgen_ty_1 {
    pub buffer: *mut ::std::os::raw::c_void,
    pub size: usize,
}
#[test]
fn bindgen_test_layout_dxbc_spirv_object__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<dxbc_spirv_object__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<dxbc_spirv_object__bindgen_ty_1>(),
        16usize,
        concat!("Size of: ", stringify!(dxbc_spirv_object__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<dxbc_spirv_object__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(dxbc_spirv_object__bindgen_ty_1))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).buffer) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(dxbc_spirv_object__bindgen_ty_1),
            "::",
            stringify!(buffer)
        )
    );
...
#[test]
fn bindgen_test_layout_dxbc_spirv_object() {
    const UNINIT: ::std::mem::MaybeUninit<dxbc_spirv_object> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<dxbc_spirv_object>(),
        24usize,
        concat!("Size of: ", stringify!(dxbc_spirv_object))
    );
    assert_eq!(
        ::std::mem::align_of::<dxbc_spirv_object>(),
        8usize,
        concat!("Alignment of ", stringify!(dxbc_spirv_object))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).metadata) as usize - ptr as usize },
        0usize,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct dxbc_spirv_compute_runtime_data {
    pub group_count_x: u32,
    pub group_count_y: u32,
    pub group_count_z: u32,
}
#[test]
fn bindgen_test_layout_dxbc_spirv_compute_runtime_data() {
    const UNINIT: ::std::mem::MaybeUninit<dxbc_spirv_compute_runtime_data> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<dxbc_spirv_compute_runtime_data>(),
        12usize,
        concat!("Size of: ", stringify!(dxbc_spirv_compute_runtime_data))
    );
    assert_eq!(
        ::std::mem::align_of::<dxbc_spirv_compute_runtime_data>(),
        4usize,
        concat!("Alignment of ", stringify!(dxbc_spirv_compute_runtime_data))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).group_count_x) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(dxbc_spirv_compute_runtime_data),
            "::",
            stringify!(group_count_x)
        )
    );
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct dxbc_spirv_vertex_runtime_data {
    pub first_vertex: u32,
    pub base_instance: u32,
    pub is_indexed_draw: bool,
}
#[test]
fn bindgen_test_layout_dxbc_spirv_vertex_runtime_data() {
    const UNINIT: ::std::mem::MaybeUninit<dxbc_spirv_vertex_runtime_data> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<dxbc_spirv_vertex_runtime_data>(),
        12usize,
        concat!("Size of: ", stringify!(dxbc_spirv_vertex_runtime_data))
    );
    assert_eq!(
        ::std::mem::align_of::<dxbc_spirv_vertex_runtime_data>(),
        4usize,
        concat!("Alignment of ", stringify!(dxbc_spirv_vertex_runtime_data))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).first_vertex) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(dxbc_spirv_vertex_runtime_data),
            "::",
            stringify!(first_vertex)
        )
    );
...
#[repr(C)]
pub struct dxbc_spirv_runtime_conf {
    pub runtime_data_cbv: BufferBinding,
    pub push_constant_cbv: BufferBinding,
    pub zero_based_vertex_instance_id: bool,
    pub shader_model_max: ShaderModel,
...
#[test]
fn bindgen_test_layout_dxbc_spirv_runtime_conf() {
    const UNINIT: ::std::mem::MaybeUninit<dxbc_spirv_runtime_conf> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<dxbc_spirv_runtime_conf>(),
        24usize,
        concat!("Size of: ", stringify!(dxbc_spirv_runtime_conf))
    );
    assert_eq!(
        ::std::mem::align_of::<dxbc_spirv_runtime_conf>(),
        4usize,
        concat!("Alignment of ", stringify!(dxbc_spirv_runtime_conf))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).runtime_data_cbv) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(dxbc_spirv_runtime_conf),
            "::",
            stringify!(runtime_data_cbv)
        )
    );
...
extern "C" {
    #[doc = " Compile a SPIR-V module into DXIL.\n \\param  words  SPIR-V module to compile\n \\param  word_count  number of words in the SPIR-V module\n \\param  specializations  specialization constants to compile with the shader\n \\param  num_specializations  number of specialization constants\n \\param  stage  shader stage\n \\param  entry_point_name  name of shader entrypoint\n \\param  conf  configuration for spriv_to_dxil\n \\param  out_dxil  will contain the DXIL bytes on success (call spirv_to_dxbc_free after use)\n \\return  true if compilation succeeded"]
    pub fn spirv_to_dxbc(
        words: *const u32,
        word_count: usize,
        specializations: *mut dxbc_spirv_specialization,
        num_specializations: ::std::os::raw::c_uint,
        stage: ShaderStage,
        entry_point_name: *const ::std::os::raw::c_char,
        conf: *const dxbc_spirv_runtime_conf,
        out_dxil: *mut dxbc_spirv_object,
    ) -> bool;
}
extern "C" {
    #[doc = " Free the buffer allocated by spirv_to_dxbc."]
    pub fn spirv_to_dxbc_free(dxil: *mut dxbc_spirv_object);
}
extern "C" {
    pub fn spirv_to_dxbc_get_version() -> u64;
}
